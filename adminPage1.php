...
<html>
    <head>
        <title></title>
        <meta charset='utf-8'>
        <link href="css/adminPage1.css" media="screen" rel="stylesheet" type="text/css">
        <a href='http://localhost/adminPage1.php?deconnexion=true'><span>Déconnexion</span></a>
...
<INPUT id="personne" class="personne" TYPE="text" NAME="personne" placeholder="&nbsp;&nbsp;&nbsp;Entrer le nom de la personne concernée">
<INPUT style="width: 170px; height: 40px;" TYPE="button" NAME="envoyer" VALUE=" Envoyer " onclick="validateForm()" >
</form>
<a href="http://localhost/adminPage2.php" target="_self"><img class="check" src="https://www.qdeclaro.com/img/Seccion-2/Check_Blanco.png"><input class="consulter" type="button" value="Consulter les demandes de réservation"></a>
</div> 
...
function validateForm() {
    var person = document.getElementById('personne').value;
    if (document.getElementById('residence').selectedIndex==0 || document.getElementById('sexe').value==0 || document.getElementById('bloc').value==0 || document.getElementById('appartement').value==0 || document.getElementById('chambre').value==0) 
    {
        document.getElementById('error').innerHTML = '<img class="err" id="error" style="width:20px; height: 20px;" src="https://s3.amazonaws.com/totalsystemcare-s3/www.driverassist.com/wp-content/uploads/2016/11/01112829/Emblem-important-yellow.svg_.png"> <h5 style="color:#D5C500">Remplissez d\'abord tous les champs</h5>'
          ...
          Swal.fire({
          icon: 'question',
          title: 'Voulez-vous ajouter un commentaire à cette réservation?',
          input: 'text',
          showCancelButton: true,
          confirmButtonColor: '#FA5322',
          ...
          inputPlaceholder: "Entrer votre commentaire"
                ...
                $.ajax({
                  type: 'POST',
                  url: 'ReservAdmin.php',
                  data: {comment: result.value, personne: person},
                  success: function() {
                    Swal.fire({
                  icon: 'success',
                  ...
                  timer: 1500
                          ...
                          window.location="http://localhost/adminPage1.php";
                        })
                }
